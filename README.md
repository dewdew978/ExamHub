# 🚀 EXETIA — คลังข้อสอบและแบบฝึกหัดออนไลน์
...
🌐 **เข้าใช้งานได้ที่**: [https://exetia-exam.vercel.app/](https://exetia-exam.vercel.app/)

---

## 📱 คู่มือการติดตั้งเป็นแอปพลิเคชัน (PWA Installation Guide)

EXETIA รองรับเทคโนโลยี **Progressive Web App (PWA)** ทำให้ผู้ใช้สามารถ **"ติดตั้งเป็นแอปพลิเคชัน"** ลงบนคอมพิวเตอร์ แท็บเล็ต หรือสมาร์ตโฟนได้โดยตรง โดย**ไม่ต้องดาวน์โหลดผ่าน App Store หรือ Google Play Store**
...
* **วิธีที่ 1 (ผ่านปุ่มแนะนำในหน้าเว็บ)**:
  1. เปิดเว็บไซต์ [EXETIA](https://exetia-exam.vercel.app/)
  2. รอประมาณ 3 วินาที จะมีแถบสีม่วงปรากฏที่มุมขวาล่างว่า **"ติดตั้งแอป EXETIA"**
...
* **วิธีที่ 2 (ผ่านแถบ URL / Address Bar)**:
  ...
  2. คลิกที่ไอคอน **หน้าจอคอมพิวเตอร์ 🖥️** หรือ **เครื่องหมายบวก (+)** (จะมีข้อความแสดงว่า *Install EXETIA* หรือ *ติดตั้ง EXETIA*)
...
1. เปิดเว็บไซต์ [EXETIA](https://exetia-exam.vercel.app/) บนเบราว์เซอร์ Chrome
...
3. *กรณีป๊อปอัปไม่แสดง*:
   ...
   * กดยืนยันการติดตั้ง
4. ไอคอน EXETIA จะปรากฏบนหน้าจอหลัก (Home Screen) ของคุณ สามารถแตะเพื่อเปิดใช้งานได้เสมือนแอปพลิเคชันทั่วไป
...
1. เปิดเว็บไซต์ [EXETIA](https://exetia-exam.vercel.app/) ด้วยเบราว์เซอร์ **Safari**
...
5. ไอคอน EXETIA จะถูกเพิ่มลงในหน้าจอโฮมของอุปกรณ์ พร้อมเปิดใช้งานแบบเต็มหน้าจอทันที
